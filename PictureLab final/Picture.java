...
public class Picture extends SimplePicture 
{
  ...
  public void keepOnlyBlue()
  {
    ...
    public void fixUnderwater()
    {
        ...
        for(Pixel[] rowArray : pixels)
        {
            for(Pixel pixelObj : rowArray)
            {
                if(pixelObj.getRed() <= 20 && pixelObj.getGreen() >150 &&pixelObj.getBlue() > 160)
                {
                    pixelObj.setRed(255);
                    pixelObj.setBlue(69);
                    pixelObj.setGreen(69);
                }
    ...
    Pixel lowerPixel = null;
      ...
      for(int r = 160; r<195; r++)
      {
          for(int c = 100; c<300; c++)
          {
              if(c<170 || c>238)
              {
                  upperPixel = pixels[r][c];
        lowerPixel = pixels[160 + 220-r][c];
        lowerPixel.setColor(upperPixel.getColor());
                }
  ...
  public void mirrorGull()
  {
    ...
    Pixel leftPixel = null;
      ...
      for(int r = 230; r<325; r++)
      {
          for(int c = 235; c<470; c++)
          {
              if(c<235 || c>342)
              {
                  leftPixel = pixels[r][c];
                 rightPixel = pixels[r][235+470-c];
    ...
    public void mirroring(int startCol, int endCol)
    {
        Pixel[][] pixels = this.getPixels2D();
        Pixel rightPixel = null;
      Pixel leftPixel = null;
